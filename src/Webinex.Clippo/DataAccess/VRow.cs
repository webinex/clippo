    ...
    where TData : class, ICloneable
{
    ...
    public void UpdatePath(Optional<string>? path)
    {
    ...
    public void UpdateFile(string? path, string name, int bytes, string @ref, string mimeType, TData data)
    {
        Path = path;
        Name = name;
        Bytes = bytes;
