        ...
        model.Entity<VRow<TMeta, TData>>(
            row =>
            {
                ...
                row.OwnsOne(
                    ...
                    vFolder =>
                    {
                        vFolder.Property(x => x.Type).HasColumnName("Folder_Type").HasMaxLength(100).IsRequired();
                        vFolder.Property(x => x.Id).HasColumnName("Folder_Id").HasMaxLength(250).IsRequired();
                    });
